...
- Thanks [Moroxide](https://thunderstore.io/c/lethal-company/p/Megalophobia/MEGALOPHOBIA/) for inspiration and terminal customization.

- Thanks [Shaydelity](https://github.com/Team-Rebirth/Lethal-Rebirth/tree/main) for inspiring me continuing doing my github page.

- Thanks to all of my Early-access testers for helping testing the pack and giving the feedback:
  - Special thanks to Gus, Strv-103 Enjoyer, Mahoraga, Yuri.
 
- Thanks to 2 of BuyMeACoffee supporters for supporting me:
  - Gus and @st.coiled

- Thanks to mod creators Moroxide and darmuh for help.

### Acknowledged Contributions

**The and only dev of modpack is [seeya](https://github.com/se3ya).**
