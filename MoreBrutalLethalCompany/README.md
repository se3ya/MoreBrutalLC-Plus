...
1. Create new profile and name it however you want and select it.
1. Download updated version of modpack.
...
- **Phones:**
  ...
  - To dial hold _[ Z ]_.
  - To toggle phone volume, use _[ G ]_.
- **Spray Paint:**
  - To erase, press _[ E ]_ + _[ LMB ]_ at the same time.
  - To change the color of spray paint press*[ N ]*.
  - Control the size of spray
    - _[ - ]_ to make spray smaller.
    - _[ + ]_ to make spray bigger.
  - To toggle phone volume, use _[ G ]_.
- **Reserved Slots:**
